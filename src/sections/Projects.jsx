...
export const Projects = () => {
  return (
    <section id="projects" aria-labelledby="projects-heading" className="py-32 relative overflow-hidden">
      {/* Bg glows */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          <h2 id="projects-heading" className="text-secondary-foreground text-sm font-medium tracking-wider uppercase animate-fade-in">
            Featured Work
          </h2>
