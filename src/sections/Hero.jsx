        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/azulgautam79" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/lemon-gautam-223439203/" },
                { icon: Twitter, href: "https://x.com/GautamLemo10270" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
          ...
          <div className="relatice animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                <img
                  src="/lemon_image.jpg"
                  alt="Lemon Gautam - Full-Stack Software Engineer"
